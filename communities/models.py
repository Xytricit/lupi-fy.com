...
class CommunityPost(models.Model):
    ...
    dislikes = models.ManyToManyField(User, related_name='disliked_community_posts', blank=True)
    bookmarks = models.ManyToManyField(User, related_name='bookmarked_community_posts', blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class CommunityPostComment(models.Model):
    ...
    likes = models.ManyToManyField(User, related_name='liked_community_post_comments', blank=True)
    dislikes = models.ManyToManyField(User, related_name='disliked_community_post_comments', blank=True)
...
class ModerationReport(models.Model):
    ...
    post = models.ForeignKey(CommunityPost, on_delete=models.CASCADE, related_name='reports', null=True, blank=True)
    comment = models.ForeignKey(CommunityPostComment, on_delete=models.CASCADE, related_name='reports', null=True, blank=True)
